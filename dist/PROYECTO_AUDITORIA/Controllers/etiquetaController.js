...
const getEtiquetas = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const etiquetaSalida = yield (0, etiquetaHandler_1.etiquetaGetHandler)();
...
const postEtiqueta = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        const etiquetaEntrada = new EtiquetaModelo_1.EtiquetaModelo();
        etiquetaEntrada.nombre = body.name;
        etiquetaEntrada.descripcion = body.description;
        const etiquetaSalida = yield (0, etiquetaHandler_1.etiquetaPostHandler)(etiquetaEntrada);
        res.status(200).json(etiquetaSalida);
    }
    catch (error) {
        console.log("error");
...
const putEtiqueta = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const etiquetaSalida = yield (0, etiquetaHandler_1.etiquetaPutHandler)(body.id, etiquetaEntrada);
        res.status(200).json(etiquetaSalida);
    }
    catch (error) {
        console.log("error");
...
const deleteEtiqueta = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        const etiquetaSalida = yield (0, etiquetaHandler_1.etiquetaDeleteHandler)(body.id);
        res.status(200).json(etiquetaSalida);
    }
    catch (error) {
        console.log("error");
