...
class DepartamentoUsuarioRepositorio {
    ...
    crearDepartamentoUsuario(DepartamentoUsuarioEntidad) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const query = `EXEC spi_insertar_bussines_unit_users '${id_business_unit}', '${id_user}'`;
            return yield this._grupo.query(query);
        });
    }
...
exports.DepartamentoUsuarioRepositorio = DepartamentoUsuarioRepositorio;
//# sourceMappingURL=DepartamentoUsuarioRepositorio%20copy.js.map