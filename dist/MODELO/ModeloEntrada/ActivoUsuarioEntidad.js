...
exports.ActivoUsuarioEntidad = void 0;
class ActivoUsuarioEntidad {
    get usr_id_user() {
        return this._usr_id_user;
    }
    set usr_id_user(value) {
    ...
    set ast_id_asset(value) {
        this._ast_id_asset = value;
    }
}
exports.ActivoUsuarioEntidad = ActivoUsuarioEntidad;
//# sourceMappingURL=ActivoUsuarioEntidad.js.map